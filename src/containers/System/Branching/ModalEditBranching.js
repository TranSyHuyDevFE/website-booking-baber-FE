...
import { editBranching } from "../../../services/userService";
class ModalEditService extends Component {
  ...
  handleSaveBranching = async () => {
    if (!this.state.name) {
      toast.error("Không được để trống tên chi nhánh!");
      return;
    }
    ...
    await editBranching(this.state);
    this.toggle();
                ...
                <div className="row">
                  <form>
                    <div className="form-row">
                      ...
                      <div className="form-group col-md-12">
                        <label htmlFor="inputPassword4">Tên chi nhánh</label>
                        <input
                          type="text"
                          className="form-control"
                          onChange={(event) => {
